          ...
          <div className="flex max-w-xl flex-col gap-6 text-center md:text-left">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-lg text-muted-foreground">
                The Public Employment Service Office (PESO) Baguio connects job
                seekers with employers, provides career guidance, and offers
                various government employment programs to empower the workforce
