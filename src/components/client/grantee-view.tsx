...
const DOCUMENTS: DocumentItem[] = [
  ...
  },
  {
    ...
    paperSize: 'A4 (8.27" x 11.69")',
    description:
      "Employment Contract between the employer and the SPES student",
  },
  {
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-[11px] text-blue-800/80 dark:text-blue-400/80 mt-2 space-y-1.5 list-disc pl-3">
                      <li>
                        Use <strong>Long Bond</strong> or <strong>A4</strong> as
                        indicated.
                      </li>
                      <li>
                        Set printer to <strong>"Actual Size"</strong> (100%
                        Scale).
                      </li>
              ...
              {selectedDoc ? (
                <div className="space-y-5">
                  <div className="aspect-[1/1.414] w-full rounded-xl border border-primary/10 bg-muted/30 overflow-hidden relative group shadow-inner">
                    {/* Removing #toolbar=0 to allow user to use browser tools if needed, but keeping it clean for preview */}
                    <iframe
                      src={`/form-layouts/${selectedDoc.file}`}
                  ...
                  <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[11px] text-muted-foreground leading-relaxed">
                        ...
                        <strong>
                          {selectedDoc.copies}{" "}
                          {selectedDoc.copies > 1 ? "copies" : "copy"}
                        </strong>{" "}
                        on <strong>{selectedDoc.paperSize}</strong>.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    <Button
                      size="lg"
                      className="h-12 font-bold shadow-md shadow-primary/20 w-full"
                      asChild
                    >
                      <Link
                ...
                <div className="aspect-[1/1.414] w-full rounded-xl border-2 border-dashed border-muted flex flex-col items-center justify-center text-muted-foreground p-8 text-center bg-muted/5">
                  ...
                  <p className="text-xs max-w-50 leading-relaxed">
                    Select a document from the left list to see its preview and
                    printing options.
                  </p>
                </div>
              )}
