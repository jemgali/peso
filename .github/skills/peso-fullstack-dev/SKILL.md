...
description: >
  This skill focuses on implementing cost-effective large language model (LLM) applications and optimizing token usage strategies in Next.js projects. It covers techniques for efficient input preprocessing, response length control, context management, and best practices for integrating LLMs in Next.js to minimize costs while maximizing performance.
---
